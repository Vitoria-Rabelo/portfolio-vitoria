...
function ProjectCard({imgUrl, title, description, gitUrl, previewUrl}) {
  return (
    <div>
      ...
      >
        <div className="overlay itemns-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
            <Link 
                href={gitUrl}
      ...
      <div className=" text-[#ADB7BE] rounded-b-xl mt-2 bg-[#181818] py-6 px-4">
